...
const Alert = ({ text }) => {
    return (
        <div class=" w-full mt-5 flex items-center justify-between p-5 leading-normal text-red-600 bg-red-100 rounded-lg" role="alert">
            <p>{text}</p>
        ...
        // <div class="w-full mx-auto bg-white p-6 md:p-14">
        ...
        /* <div class="mt-5 flex items-center justify-between p-5 leading-normal text-green-600 bg-green-100 rounded-lg" role="alert">
            <p>Success alert</p>
